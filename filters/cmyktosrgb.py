...
# This Filter is based on the commit https://github.com/thumbor/thumbor/pull/927/commits/0311feec0ffb9e01a24fc5a22dcd47c91718706a made by Konstantin Kopachev
# kkopachev : https://github.com/kkopachev
        ...
        if not embedded_profile:
            ...
            if image.mode == 'CMYK':
                ...
                if os.path.exists(filepath):
                    ...
                    logger.debug('Could not find icc profile @ : {:s}'.format(filepath))
                    return
        else:
            logger.debug('Image does have embedded profile.')
